...
public class AuthService {
    ...
    public UserResponseDTO register(UserRequestDTO userRequestDTO) {
        ...
        // );
        // Check UserEntity.java to be sure, but it is likely this:
// DANS AuthService.java, méthode register :

UserEntity user = new UserEntity(
    userRequestDTO.getUsername(),                         // 1. Username
    passwordEncoder.encode(userRequestDTO.getPassword()), // 2. Password (Crypté)
    userRequestDTO.getEmail()                             // 3. Email
);
